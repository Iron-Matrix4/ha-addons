...
def analyze_camera(camera_entity: str, question: str = "Describe this scene in a natural, conversational way."):
    """
    ...
    try:
        ...
        if config.GCP_PROJECT_ID:
            ...
            # Use Gemini 2.0 Flash Exp for vision (available in us-central1)
